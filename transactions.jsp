    ...
    if (startDate != null && endDate != null) {
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(
                "SELECT * FROM Transactions WHERE CustomerID = ? AND TransactionDate BETWEEN ? AND ? ORDER BY TransactionDate DESC"
            );
            ...
            response.sendRedirect("transactionsResult.jsp");
        } catch (Exception e) {
            e.printStackTrace();
        ...
        // Display the transactions search form
        %>
        <!DOCTYPE html>
        <html lang="en">
        <head>
            ...
            <div class="container">
                <div class="dashboard-grid">
                    <div class="main-content">
                        <h2 class="section-title"><i class="fas fa-history"></i> Inquire Transactions</h2>
                        ...
                        <script>
                            // Set default dates (today and one month ago)
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-section">
                            ...
                            <p>Search for transactions within a specific date range. All transactions are securely recorded in our system.</p>
                        </div>
                    </div>
                </div>
            </div>
